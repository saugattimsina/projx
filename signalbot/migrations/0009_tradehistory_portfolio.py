    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade_side', models.CharField(choices=[('buy', 'buy'), ('sell', 'sell')], max_length=255)),
                ('profit_loss', models.FloatField()),
                ('trade_fee', models.FloatField()),
                ('fee_currency', models.CharField(max_length=255)),
                ('created_on', models.DateTimeField(blank=True, null=True)),
                ('symbol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='signalbot.tradesymbol')),
